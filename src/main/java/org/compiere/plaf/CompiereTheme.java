...
public class CompiereTheme extends MetalTheme {
	...
	public void addCustomEntriesToTable(UIDefaults table) {
		...
		Object[] defaults = { ExtendedTheme.ERROR_BG_KEY, error, ExtendedTheme.ERROR_FG_KEY, txt_error,
				ExtendedTheme.INACTIVE_BG_KEY, inactive, ExtendedTheme.INFO_BG_KEY, info,
