...
/**
 * Convenience Dialog Class. Adempiere Background + Dispose on Close
...
public class CDialog extends JDialog implements ActionListener, MouseListener {
	...
	/** ALT-EXCAPE */
	protected static KeyStroke s_disposeKeyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_PAUSE, InputEvent.ALT_MASK);
